...
export default function Section5() {
  ...
  const [slideWidth, setSlideWidth] = useState(1260);
  ...
  return (
    <div className="section5">
      <div className="container">
        <div className="row">
          <div className="main">
            <p className="cardTitle">Kursning afzalliklari qanday?</p>
            <div className="textButton">
              <p className="text">
                Onlayn videokurs va ustoz nazorati ostida o‘tiladi. Har bir dars
                materiallari avvaldan ishlab chiqilgan va yuqori sifatga ega
                muallifning mehnat mahsuli hisoblanadi.
              </p>
